...
public class PhrasesResource {
	...
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	@Path("motivational")
	public String readMotivationalPhrase(@QueryParam("personName") String personName) {
		Random r = new Random();
		XMLParser parser = null;
		try {
			//TODO
			parser = new XMLParser("C:/Users/Alex/git/edu.sagado.SDE.LifeCoach/LifeCoach/src/main/resources/motivationalPhrases.xml");
		...
		return personName + ", " + phrase.substring(0, 1).toLowerCase() + phrase.substring(1);
	}
