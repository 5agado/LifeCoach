...
public class JodaDateTimeConverter implements Converter {
	...
	/*
	 * @Override public Object convertDataValueToObjectValue(Object dataValue,
	 * Session session) { return dataValue == null ? null : new
	 * DateTime((Timestamp) dataValue); }
	 * 
	 * @Override public Object convertObjectValueToDataValue(Object objectValue,
	 * Session session) { return objectValue == null ? null : new
	 * Timestamp(((DateTime) objectValue).getMillis()); }
	 * 
	 * @Override public void initialize(DatabaseMapping mapping, Session
	 * session) { }
	 * 
